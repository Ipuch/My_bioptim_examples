...
def main(n_shooting_per_second: int,
    ...
    # --- Prepare the ocp --- #
    ocp = prepare_ocp(biorbd_model_path="models/pendulum.bioMod", final_time=1,
    ...
    sol = ocp.solve(solver_options=options)
    sol.print()
...
def compute_error_single_shooting(ocp, sol, duration):
    ...
    sol_int = sol.integrate(shooting_type=Shooting.SINGLE_CONTINUOUS, use_scipy_integrator=True, keep_intermediate_points=True)
