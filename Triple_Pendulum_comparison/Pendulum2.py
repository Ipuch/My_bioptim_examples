...
def main(n_shooting_per_second: int = 50,
         ode_solver: OdeSolver = OdeSolver.RK4(),
         tol: float = 1e-8,
    ...
    # --- Prepare the ocp --- #
    ocp = prepare_ocp(biorbd_model_path="models/triple_pendulum.bioMod", final_time=1,
...
def compute_error_single_shooting(sol, duration: float = 1, scipy_integrator: str = 'RK45'):
    ...
    sol_int = sol.integrate(shooting_type=Shooting.SINGLE_CONTINUOUS, merge_phases=True, use_scipy_integrator=True,
                            scipy_integrator=scipy_integrator, keep_intermediate_points=False)
...
if __name__ == "__main__":
    ...
    sol.print()
    # sol.animate()
    print(compute_error_single_shooting(sol, duration=1, scipy_integrator='RK23'))
    print(compute_error_single_shooting(sol, duration=1, scipy_integrator='RK45'))
    print(compute_error_single_shooting(sol, duration=1, scipy_integrator='DOP853'))
    print(compute_error_single_shooting(sol, duration=1, scipy_integrator='BDF'))
    print(compute_error_single_shooting(sol, duration=1, scipy_integrator='LSODA'))